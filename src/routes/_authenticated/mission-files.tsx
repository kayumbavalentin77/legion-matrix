...
export const Route = createFileRoute("/_authenticated/mission-files")({
  head: () => ({
    meta: [
      { title: "Mission Files | Military Management System" },
      { name: "description", content: "Document-based mission and event files with references and attachments." },
      { property: "og:title", content: "Mission Files | Military Management System" },
      { property: "og:description", content: "Document-based mission and event files with references and attachments." },
    ],
  }),
  component: MissionFilesPage,
});

function MissionFilesPage() {
  ...
  return (
    <ResourcePage
      title="Mission Files"
      description="Document-based mission and event files with references and attachments."
      module="Mission File"
      table="operations"
      select="*, units(name)"
      orderBy="start_date"
      ...
      searchKeys={["reference_number", "title", "responsible_officer", "description"]}
