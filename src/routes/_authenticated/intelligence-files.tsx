...
export const Route = createFileRoute("/_authenticated/intelligence-files")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Categorised, searchable file register for authorised users." },
      { property: "og:title", content: "Intelligence Files | Military Management System" },
      { property: "og:description", content: "Categorised, searchable file register for authorised users." },
    ],
  }),
  component: IntelFilesPage,
});

function IntelFilesPage() {
  ...
  return (
    <ResourcePage
      ...
      description="Categorised, searchable file register for authorised users."
      module="Intelligence File"
      table="documents"
      select="*, units(name)"
